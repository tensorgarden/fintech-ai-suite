...
export const fraudAlerts: FraudAlert[] = [
  { id: "fa-001", transactionId: "tx-005", severity: "high", riskScore: 87, title: "Large Offshore Transfer", description: "$500K customer-authorized transfer to a jurisdiction flagged as high-risk by FATF. Transaction originates from a recently opened account.", detectedAt: "2026-06-09T07:16:00Z", status: "new", category: "geographic", modelConfidence: 91, falsePositiveRisk: 18, customerAuthorized: true, settlementWindowSeconds: 180, interventionAction: "pause_payment", recommendedAction: "Hold payment and verify beneficiary ownership before release." },
  { id: "fa-002", transactionId: "tx-009", severity: "medium", riskScore: 62, title: "Pattern Deviation: Crypto Sell-off", description: "Unusual sell pattern in crypto equities diverges from portfolio's historical buy-and-hold behavior.", detectedAt: "2026-06-08T10:12:00Z", status: "investigating", category: "anomaly", modelConfidence: 74, falsePositiveRisk: 42, customerAuthorized: false, settlementWindowSeconds: 1800, interventionAction: "analyst_review", recommendedAction: "Compare against historical crypto allocation policy before escalating to compliance." },
  { id: "fa-003", transactionId: "tx-011", severity: "high", riskScore: 79, title: "Regulatory Threshold Breach", description: "Customer-approved transfer exceeds $500K reporting threshold. Source of funds not yet verified.", detectedAt: "2026-06-07T18:30:00Z", status: "new", category: "aml", modelConfidence: 88, falsePositiveRisk: 22, customerAuthorized: true, settlementWindowSeconds: 240, interventionAction: "pause_payment", recommendedAction: "Pause payment, file SAR review packet, and request source-of-funds attestation." },
  { id: "fa-004", transactionId: "tx-015", severity: "medium", riskScore: 55, title: "Insider Window Correlation", description: "Bond sale timing aligns with known insider trading window for related securities.", detectedAt: "2026-06-06T16:25:00Z", status: "investigating", category: "anomaly", modelConfidence: 67, falsePositiveRisk: 51, customerAuthorized: false, settlementWindowSeconds: 3600, interventionAction: "analyst_review", recommendedAction: "Check employee watchlist and market-news timing before formal investigation." },
  { id: "fa-005", severity: "critical", riskScore: 94, title: "Identity Verification Failure", description: "Multiple KYC document mismatches detected for Phoenix Ventures account. Possible synthetic identity.", detectedAt: "2026-06-09T06:00:00Z", status: "new", category: "identity", modelConfidence: 96, falsePositiveRisk: 9, customerAuthorized: false, settlementWindowSeconds: 120, interventionAction: "step_up_verification", recommendedAction: "Freeze onboarding workflow and request live document re-verification." },
  { id: "fa-006", severity: "low", riskScore: 28, title: "Velocity Check: Rapid Trading", description: "Three consecutive trades executed within 5 minutes. Within tolerance but flagged for review.", detectedAt: "2026-06-08T14:55:00Z", status: "dismissed", category: "velocity", modelConfidence: 53, falsePositiveRisk: 68, customerAuthorized: false, settlementWindowSeconds: 7200, interventionAction: "analyst_review", recommendedAction: "Route to analyst sampling queue; likely benign unless paired with login anomalies." },
  { id: "fa-007", severity: "high", riskScore: 81, title: "Suspicious Structuring Pattern", description: "Multiple sub-$10K transactions detected across accounts, potentially structured to avoid reporting and mule-account detection.", detectedAt: "2026-06-08T09:30:00Z", status: "new", category: "aml", modelConfidence: 84, falsePositiveRisk: 28, customerAuthorized: false, settlementWindowSeconds: 210, interventionAction: "freeze_mule_route", recommendedAction: "Aggregate linked accounts and freeze mule-route settlement while reviewing structuring evidence." },
  { id: "fa-008", severity: "medium", riskScore: 48, title: "Geographic Anomaly: IP Mismatch", description: "Login from unrecognized jurisdiction during a customer-authorized session. Account normally accessed from New York; this login originated in Eastern Europe.", detectedAt: "2026-06-07T22:15:00Z", status: "investigating", category: "geographic", modelConfidence: 72, falsePositiveRisk: 46, customerAuthorized: true, settlementWindowSeconds: 240, interventionAction: "step_up_verification", recommendedAction: "Challenge with step-up authentication and verify recent travel notes." },
];
