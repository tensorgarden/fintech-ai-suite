...
export const fraudAlerts: FraudAlert[] = [
  { id: "fa-001", transactionId: "tx-005", severity: "high", riskScore: 87, title: "Large Offshore Transfer", description: "$500K transfer to a jurisdiction flagged as high-risk by FATF. Transaction originates from a recently opened account.", detectedAt: "2026-06-09T07:16:00Z", status: "new", category: "geographic" },
  { id: "fa-002", transactionId: "tx-009", severity: "medium", riskScore: 62, title: "Pattern Deviation: Crypto Sell-off", description: "Unusual sell pattern in crypto equities diverges from portfolio's historical buy-and-hold behavior.", detectedAt: "2026-06-08T10:12:00Z", status: "investigating", category: "anomaly" },
  { id: "fa-003", transactionId: "tx-011", severity: "high", riskScore: 79, title: "Regulatory Threshold Breach", description: "Single transfer exceeds $500K reporting threshold. Source of funds not yet verified.", detectedAt: "2026-06-07T18:30:00Z", status: "new", category: "aml" },
  { id: "fa-004", transactionId: "tx-015", severity: "medium", riskScore: 55, title: "Insider Window Correlation", description: "Bond sale timing aligns with known insider trading window for related securities.", detectedAt: "2026-06-06T16:25:00Z", status: "investigating", category: "anomaly" },
  { id: "fa-005", severity: "critical", riskScore: 94, title: "Identity Verification Failure", description: "Multiple KYC document mismatches detected for Phoenix Ventures account. Possible synthetic identity.", detectedAt: "2026-06-09T06:00:00Z", status: "new", category: "identity" },
  { id: "fa-006", severity: "low", riskScore: 28, title: "Velocity Check: Rapid Trading", description: "Three consecutive trades executed within 5 minutes. Within tolerance but flagged for review.", detectedAt: "2026-06-08T14:55:00Z", status: "dismissed", category: "velocity" },
  ...
  { id: "fa-008", severity: "medium", riskScore: 48, title: "Geographic Anomaly: IP Mismatch", description: "Login from unrecognized jurisdiction. Account normally accessed from New York; this login originated in Eastern Europe.", detectedAt: "2026-06-07T22:15:00Z", status: "investigating", category: "geographic" },
];
