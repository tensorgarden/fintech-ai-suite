...
export const fraudAlerts: FraudAlert[] = [
  { id: "fa-001", transactionId: "tx-005", severity: "high", riskScore: 87, title: "Large Offshore Transfer", description: "$500K customer-authorized transfer to a jurisdiction flagged as high-risk by FATF. Transaction originates from a recently opened account.", detectedAt: "2026-06-09T07:16:00Z", status: "new", category: "geographic", modelConfidence: 91, falsePositiveRisk: 18, fundsMovementChannel: "ach_credit_push", counterpartyReviewStatus: "coordinated_review", counterpartyIntelligenceStatus: "scam_watchlist_hit", customerAuthorized: true, customerOutreachStatus: "challenge_sent", beneficiaryRiskSignals: ["new_beneficiary", "payee_name_mismatch", "high_risk_jurisdiction"], accountHandoverSignals: ["new_device_after_kyc", "credential_reset_before_transfer", "behavioral_biometrics_shift"], settlementWindowSeconds: 180, interventionAction: "pause_payment", recommendedAction: "Hold payment and verify beneficiary ownership before release." },
  { id: "fa-002", transactionId: "tx-009", severity: "medium", riskScore: 62, title: "Pattern Deviation: Crypto Sell-off", description: "Unusual sell pattern in crypto equities diverges from portfolio's historical buy-and-hold behavior.", detectedAt: "2026-06-08T10:12:00Z", status: "investigating", category: "anomaly", modelConfidence: 74, falsePositiveRisk: 42, fundsMovementChannel: "crypto", counterpartyReviewStatus: "not_required", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: false, customerOutreachStatus: "not_required", beneficiaryRiskSignals: ["session_anomaly"], accountHandoverSignals: ["behavioral_biometrics_shift"], settlementWindowSeconds: 1800, interventionAction: "analyst_review", recommendedAction: "Compare against historical crypto allocation policy before escalating to compliance." },
  { id: "fa-003", transactionId: "tx-011", severity: "high", riskScore: 79, title: "Regulatory Threshold Breach", description: "Customer-approved transfer exceeds $500K reporting threshold. Source of funds not yet verified.", detectedAt: "2026-06-07T18:30:00Z", status: "new", category: "aml", modelConfidence: 88, falsePositiveRisk: 22, fundsMovementChannel: "wire", counterpartyReviewStatus: "originator_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: true, customerOutreachStatus: "queued", beneficiaryRiskSignals: ["new_beneficiary", "high_risk_jurisdiction"], accountHandoverSignals: ["new_device_after_kyc"], settlementWindowSeconds: 240, interventionAction: "pause_payment", recommendedAction: "Pause payment, file SAR review packet, and request source-of-funds attestation." },
  { id: "fa-004", transactionId: "tx-015", severity: "medium", riskScore: 55, title: "Insider Window Correlation", description: "Bond sale timing aligns with known insider trading window for related securities.", detectedAt: "2026-06-06T16:25:00Z", status: "investigating", category: "anomaly", modelConfidence: 67, falsePositiveRisk: 51, fundsMovementChannel: "securities_trade", counterpartyReviewStatus: "not_required", counterpartyIntelligenceStatus: "clear", customerAuthorized: false, customerOutreachStatus: "not_required", beneficiaryRiskSignals: ["session_anomaly"], accountHandoverSignals: [], settlementWindowSeconds: 3600, interventionAction: "analyst_review", recommendedAction: "Check employee watchlist and market-news timing before formal investigation." },
  { id: "fa-005", severity: "critical", riskScore: 94, title: "Identity Verification Failure", description: "Multiple KYC document mismatches detected for Phoenix Ventures account. Possible synthetic identity.", detectedAt: "2026-06-09T06:00:00Z", status: "new", category: "identity", modelConfidence: 96, falsePositiveRisk: 9, fundsMovementChannel: "card", counterpartyReviewStatus: "originator_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: false, customerOutreachStatus: "challenge_sent", beneficiaryRiskSignals: ["payee_name_mismatch", "device_handoff"], accountHandoverSignals: ["new_device_after_kyc", "sim_swap_indicator"], settlementWindowSeconds: 120, interventionAction: "step_up_verification", recommendedAction: "Freeze onboarding workflow and request live document re-verification." },
  { id: "fa-006", severity: "low", riskScore: 28, title: "Velocity Check: Rapid Trading", description: "Three consecutive trades executed within 5 minutes. Within tolerance but flagged for review.", detectedAt: "2026-06-08T14:55:00Z", status: "dismissed", category: "velocity", modelConfidence: 53, falsePositiveRisk: 68, fundsMovementChannel: "securities_trade", counterpartyReviewStatus: "not_required", counterpartyIntelligenceStatus: "clear", customerAuthorized: false, customerOutreachStatus: "not_required", beneficiaryRiskSignals: ["session_anomaly"], accountHandoverSignals: [], settlementWindowSeconds: 7200, interventionAction: "analyst_review", recommendedAction: "Route to analyst sampling queue; likely benign unless paired with login anomalies." },
  { id: "fa-007", severity: "high", riskScore: 81, title: "Suspicious Structuring Pattern", description: "Multiple sub-$10K transactions detected across accounts, potentially structured to avoid reporting and mule-account detection.", detectedAt: "2026-06-08T09:30:00Z", status: "new", category: "aml", modelConfidence: 84, falsePositiveRisk: 28, fundsMovementChannel: "ach_credit_push", counterpartyReviewStatus: "receiving_bank_review", counterpartyIntelligenceStatus: "mule_cluster_match", customerAuthorized: false, customerOutreachStatus: "not_required", beneficiaryRiskSignals: ["mule_network_link", "new_beneficiary"], accountHandoverSignals: ["session_cookie_replay", "behavioral_biometrics_shift"], settlementWindowSeconds: 210, interventionAction: "freeze_mule_route", recommendedAction: "Aggregate linked accounts and freeze mule-route settlement while reviewing structuring evidence." },
  { id: "fa-008", severity: "medium", riskScore: 48, title: "Geographic Anomaly: IP Mismatch", description: "Login from unrecognized jurisdiction during a customer-authorized session. Account normally accessed from New York; this login originated in Eastern Europe.", detectedAt: "2026-06-07T22:15:00Z", status: "investigating", category: "geographic", modelConfidence: 72, falsePositiveRisk: 46, fundsMovementChannel: "instant_payment", counterpartyReviewStatus: "receiving_bank_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: true, customerOutreachStatus: "challenge_sent", beneficiaryRiskSignals: ["device_handoff", "session_anomaly"], accountHandoverSignals: ["new_device_after_kyc", "session_cookie_replay"], settlementWindowSeconds: 240, interventionAction: "step_up_verification", recommendedAction: "Challenge with step-up authentication and verify recent travel notes." },
];
