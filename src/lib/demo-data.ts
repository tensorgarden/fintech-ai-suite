...
export const fraudAlerts: FraudAlert[] = [
  { id: "fa-001", transactionId: "tx-005", severity: "high", riskScore: 87, title: "Large Offshore Transfer", description: "$500K customer-authorized transfer follows an online investment solicitation and targets a jurisdiction flagged as high-risk by FATF. Transaction originates from a recently opened account, and a same-session recovery-phone change makes the in-session contact path untrusted.", detectedAt: "2026-06-09T07:16:00Z", status: "new", category: "geographic", modelConfidence: 91, falsePositiveRisk: 18, fundsMovementChannel: "ach_credit_push", counterpartyReviewStatus: "coordinated_review", counterpartyIntelligenceStatus: "scam_watchlist_hit", customerAuthorized: true, scamOriginChannel: "online_platform", customerOutreachStatus: "challenge_sent", customerContactIntegrityStatus: "independent_contact_required", paymentInstructionVerificationStatus: "bank_account_mismatch", appReimbursementStatus: "assessment_due", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "customer_notified", payeeNameCheckStatus: "no_match", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["new_beneficiary", "payee_name_mismatch", "high_risk_jurisdiction"], accountHandoverSignals: ["new_device_after_kyc", "credential_reset_before_transfer", "behavioral_biometrics_shift"], aiImpersonationSignals: [], settlementWindowSeconds: 180, interventionAction: "pause_payment", recommendedAction: "Hold payment and verify beneficiary ownership through a trusted contact channel captured before the recovery-phone change." },
  { id: "fa-002", transactionId: "tx-009", severity: "medium", riskScore: 62, title: "Pattern Deviation: Crypto Sell-off", description: "Unusual sell pattern in crypto equities diverges from portfolio's historical buy-and-hold behavior.", detectedAt: "2026-06-08T10:12:00Z", status: "investigating", category: "anomaly", modelConfidence: 74, falsePositiveRisk: 42, fundsMovementChannel: "crypto", counterpartyReviewStatus: "not_required", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: false, scamOriginChannel: "not_applicable", customerOutreachStatus: "not_required", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "not_required", payeeNameCheckStatus: "not_required", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["session_anomaly"], accountHandoverSignals: ["behavioral_biometrics_shift"], aiImpersonationSignals: [], settlementWindowSeconds: 1800, interventionAction: "analyst_review", recommendedAction: "Compare against historical crypto allocation policy before escalating to compliance." },
  { id: "fa-003", transactionId: "tx-011", severity: "high", riskScore: 79, title: "Regulatory Threshold Breach", description: "Customer-approved transfer follows an emailed supplier-account change and exceeds the $500K reporting threshold. The changed banking instructions have not been independently verified. The customer has filed an APP scam reimbursement claim that is now under shared sending/receiving PSP liability review.", detectedAt: "2026-06-07T18:30:00Z", status: "new", category: "aml", modelConfidence: 88, falsePositiveRisk: 22, fundsMovementChannel: "wire", counterpartyReviewStatus: "originator_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: true, scamOriginChannel: "email", customerOutreachStatus: "queued", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "change_unverified", appReimbursementStatus: "claim_under_review", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "customer_notice_due", payeeNameCheckStatus: "no_match", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["new_beneficiary", "high_risk_jurisdiction"], accountHandoverSignals: ["new_device_after_kyc"], aiImpersonationSignals: [], settlementWindowSeconds: 240, interventionAction: "pause_payment", recommendedAction: "Pause payment, verify the changed supplier instructions through a pre-existing vendor-master callback, and assemble the SAR review packet." },
  { id: "fa-004", transactionId: "tx-015", severity: "medium", riskScore: 55, title: "Insider Window Correlation", description: "Bond sale timing aligns with known insider trading window for related securities.", detectedAt: "2026-06-06T16:25:00Z", status: "investigating", category: "anomaly", modelConfidence: 67, falsePositiveRisk: 51, fundsMovementChannel: "securities_trade", counterpartyReviewStatus: "not_required", counterpartyIntelligenceStatus: "clear", customerAuthorized: false, scamOriginChannel: "not_applicable", customerOutreachStatus: "not_required", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "not_required", payeeNameCheckStatus: "not_required", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["session_anomaly"], accountHandoverSignals: [], aiImpersonationSignals: [], settlementWindowSeconds: 3600, interventionAction: "analyst_review", recommendedAction: "Check employee watchlist and market-news timing before formal investigation." },
  { id: "fa-005", severity: "critical", riskScore: 94, title: "Identity Verification Failure", description: "Multiple KYC document mismatches and deepfake injection artifacts detected in the liveness capture for Phoenix Ventures. Possible synthetic identity.", detectedAt: "2026-06-09T06:00:00Z", status: "new", category: "identity", modelConfidence: 96, falsePositiveRisk: 9, fundsMovementChannel: "card", counterpartyReviewStatus: "originator_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: false, scamOriginChannel: "online_platform", customerOutreachStatus: "challenge_sent", customerContactIntegrityStatus: "independent_contact_required", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "not_required", payeeNameCheckStatus: "not_available", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["payee_name_mismatch", "device_handoff"], accountHandoverSignals: ["new_device_after_kyc", "sim_swap_indicator"], aiImpersonationSignals: ["deepfake_injection_suspected", "synthetic_document_artifact"], settlementWindowSeconds: 120, interventionAction: "step_up_verification", recommendedAction: "Freeze onboarding workflow, run an independent liveness challenge, and request live document re-verification." },
  { id: "fa-006", severity: "low", riskScore: 28, title: "Velocity Check: Rapid Trading", description: "Three consecutive trades executed within 5 minutes. Within tolerance but flagged for review.", detectedAt: "2026-06-08T14:55:00Z", status: "dismissed", category: "velocity", modelConfidence: 53, falsePositiveRisk: 68, fundsMovementChannel: "securities_trade", counterpartyReviewStatus: "not_required", counterpartyIntelligenceStatus: "clear", customerAuthorized: false, scamOriginChannel: "not_applicable", customerOutreachStatus: "not_required", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "not_required", payeeNameCheckStatus: "not_required", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["session_anomaly"], accountHandoverSignals: [], aiImpersonationSignals: [], settlementWindowSeconds: 7200, interventionAction: "analyst_review", recommendedAction: "Route to analyst sampling queue; likely benign unless paired with login anomalies." },
  { id: "fa-007", severity: "high", riskScore: 81, title: "Suspicious Structuring Pattern", description: "Multiple sub-$10K transactions follow a recovery-email change that blocked routine outreach, potentially structured to avoid reporting and mule-account detection.", detectedAt: "2026-06-08T09:30:00Z", status: "new", category: "aml", modelConfidence: 84, falsePositiveRisk: 28, fundsMovementChannel: "ach_credit_push", counterpartyReviewStatus: "receiving_bank_review", counterpartyIntelligenceStatus: "mule_cluster_match", customerAuthorized: false, scamOriginChannel: "unknown", customerOutreachStatus: "not_required", customerContactIntegrityStatus: "outbound_channel_blocked", paymentInstructionVerificationStatus: "existing_instructions_match", appReimbursementStatus: "not_applicable", muleInvolvementRole: "witting_participant", paymentDelayReviewStatus: "reasonable_suspicion_recorded", payeeNameCheckStatus: "match", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["mule_network_link", "new_beneficiary"], accountHandoverSignals: ["session_cookie_replay", "behavioral_biometrics_shift"], aiImpersonationSignals: [], settlementWindowSeconds: 210, interventionAction: "freeze_mule_route", recommendedAction: "Aggregate linked accounts, freeze mule-route settlement, and verify through a pre-change customer contact channel." },
  { id: "fa-008", severity: "medium", riskScore: 48, title: "Geographic Anomaly: IP Mismatch", description: "Login from an unrecognized jurisdiction during a customer-authorized session while the customer reports voice-clone artifacts on a live phone call with an alleged bank investigator. A recent recovery-phone change makes the in-session contact path untrusted. Account normally accessed from New York; this login originated in Eastern Europe.", detectedAt: "2026-06-07T22:15:00Z", status: "investigating", category: "geographic", modelConfidence: 72, falsePositiveRisk: 46, fundsMovementChannel: "instant_payment", counterpartyReviewStatus: "receiving_bank_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: true, scamOriginChannel: "telecom", customerOutreachStatus: "challenge_sent", customerContactIntegrityStatus: "recent_contact_change", paymentInstructionVerificationStatus: "existing_instructions_match", appReimbursementStatus: "assessment_due", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "customer_notified", payeeNameCheckStatus: "match", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["device_handoff", "session_anomaly"], accountHandoverSignals: ["new_device_after_kyc", "session_cookie_replay"], aiImpersonationSignals: ["voice_clone_suspected", "authority_impersonation"], settlementWindowSeconds: 240, interventionAction: "step_up_verification", recommendedAction: "Pause release, challenge with step-up authentication, and verify the caller through a trusted-channel callback." },
  { id: "fa-009", severity: "high", riskScore: 88, title: "Mule-Network Convergence Pattern Detected", description: "Three customer accounts (p-001, p-002, p-004) share transfers to the same destination identified in FinCEN mule-cluster intelligence linked to prior fraud cases. No single transaction is large ($45K, $62K, $58K), but convergence pattern and shared destination match FCA multi-firm mule-detection review findings. Benign convergence is ruled out by destination blacklist hit and post-onboarding device handoff timing.", detectedAt: "2026-06-09T14:30:00Z", status: "new", category: "aml", modelConfidence: 89, falsePositiveRisk: 19, fundsMovementChannel: "ach_credit_push", counterpartyReviewStatus: "coordinated_review", counterpartyIntelligenceStatus: "mule_cluster_match", customerAuthorized: false, scamOriginChannel: "not_applicable", customerOutreachStatus: "not_required", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "reasonable_suspicion_recorded", payeeNameCheckStatus: "not_required", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["mule_network_link"], accountHandoverSignals: ["behavioral_biometrics_shift"], aiImpersonationSignals: [], settlementWindowSeconds: 150, interventionAction: "freeze_mule_route", recommendedAction: "Halt all three ACH settlement, aggregate mule-cluster evidence across accounts, file SARs with receiving-bank coordination, and initiate beneficiary-account freeze via FinCEN notice." },
  { id: "fa-010", severity: "high", riskScore: 89, title: "Elder Financial Exploitation: Imposter Wire Request", description: "An 81-year-old customer approved a $185K wire to a new beneficiary after a phone call from a caller claiming to be a bank fraud investigator who directed a transfer to a 'safe account'. Confirmation of Payee returns no name match for the receiving account, and the customer's daughter is a trusted contact designated on file. The pattern is consistent with FinCEN elder-scam typologies, where roughly 80% of elder financial exploitation reports involve transfers to strangers or imposters.", detectedAt: "2026-06-09T15:40:00Z", status: "new", category: "aml", modelConfidence: 90, falsePositiveRisk: 15, fundsMovementChannel: "wire", counterpartyReviewStatus: "receiving_bank_review", counterpartyIntelligenceStatus: "scam_watchlist_hit", customerAuthorized: true, scamOriginChannel: "telecom", customerOutreachStatus: "queued", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "assessment_due", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "customer_notice_due", payeeNameCheckStatus: "no_match", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "designated_outreach_queued", beneficiaryRiskSignals: ["new_beneficiary", "payee_name_mismatch"], accountHandoverSignals: ["behavioral_biometrics_shift"], aiImpersonationSignals: [], settlementWindowSeconds: 240, interventionAction: "pause_payment", recommendedAction: "Pause the wire and complete trusted-contact outreach to the customer's daughter designated on file before any release; prepare referral to the DOJ National Elder Fraud Hotline (833-FRAUD-11) and Adult Protective Services, and include elder-financial-exploitation details in the SAR narrative." },
  { id: "fa-011", severity: "high", riskScore: 83, title: "Recruited Mule Pass-Through Activity", description: "The customer's account received four inbound instant payments from unrelated third parties within 36 hours and immediately forwarded the combined funds to a single external beneficiary. During outreach the customer reported being hired through a social-media work-from-home 'payment processing' offer and does not recognize the incoming senders, matching FBI money-mule recruitment typologies. The account's interaction pattern shifted from long-term portfolio review to rapid copy-paste transfer flows, and Confirmation of Payee returns no name match on the outbound beneficiary.", detectedAt: "2026-06-09T16:05:00Z", status: "new", category: "aml", modelConfidence: 87, falsePositiveRisk: 24, fundsMovementChannel: "instant_payment", counterpartyReviewStatus: "receiving_bank_review", counterpartyIntelligenceStatus: "mule_cluster_match", customerAuthorized: false, scamOriginChannel: "online_platform", customerOutreachStatus: "queued", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "unwitting_recruit", paymentDelayReviewStatus: "customer_notice_due", payeeNameCheckStatus: "no_match", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["mule_network_link", "new_beneficiary"], accountHandoverSignals: ["behavioral_biometrics_shift"], aiImpersonationSignals: [], settlementWindowSeconds: 180, interventionAction: "freeze_mule_route", recommendedAction: "Freeze the outbound pass-through settlement, pause the onward beneficiary transfer, warn the customer that their account is being used in a fake work-from-home job scam, and provide mule-awareness education before releasing any held funds." },
  { id: "fa-012", severity: "high", riskScore: 86, title: "QR-Code Wallet Redirection", description: "Customer authorized a $24K crypto payment after a fake support message instructed them to scan a QR code that resolved to an attacker-controlled wallet. The destination is newly seen and the transfer is typically irreversible, so a successful login or wallet signature is not proof the customer intended this recipient.", detectedAt: "2026-06-09T16:40:00Z", status: "new", category: "anomaly", modelConfidence: 85, falsePositiveRisk: 21, fundsMovementChannel: "crypto", counterpartyReviewStatus: "coordinated_review", counterpartyIntelligenceStatus: "scam_watchlist_hit", customerAuthorized: true, scamOriginChannel: "qr_code", customerOutreachStatus: "queued", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", paymentDelayReviewStatus: "not_required", payeeNameCheckStatus: "not_available", agentAuthorizationStatus: "not_applicable", trustedContactOutreachStatus: "not_required", beneficiaryRiskSignals: ["new_beneficiary", "session_anomaly"], accountHandoverSignals: [], aiImpersonationSignals: [], settlementWindowSeconds: 180, interventionAction: "pause_payment", recommendedAction: "Pause the crypto transfer, show the resolved wallet destination, contact the customer through a trusted channel, and preserve the QR payload for exchange and law-enforcement reporting." },
  { id: "fa-013", severity: "high", riskScore: 92, title: "Agent Spend Mandate Exceeded", description: "An autonomous treasury agent attempted an instant payment to a new beneficiary above its signed spend mandate. A new device identity attestation appeared immediately before the request. The payee name is a close match for the receiving account, but the instruction is outside the approved amount and merchant scope, so machine-speed execution must stop at the deterministic authorization boundary.", detectedAt: "2026-06-09T16:55:00Z", status: "new", category: "anomaly", modelConfidence: 93, falsePositiveRisk: 12, fundsMovementChannel: "instant_payment", counterpartyReviewStatus: "coordinated_review", counterpartyIntelligenceStatus: "manual_verification", customerAuthorized: false, scamOriginChannel: "not_applicable", customerOutreachStatus: "not_required", customerContactIntegrityStatus: "trusted_channels_intact", paymentInstructionVerificationStatus: "not_required", paymentDelayReviewStatus: "reasonable_suspicion_recorded", payeeNameCheckStatus: "close_match", agentAuthorizationStatus: "scope_exceeded", trustedContactOutreachStatus: "not_required", appReimbursementStatus: "not_applicable", muleInvolvementRole: "not_applicable", beneficiaryRiskSignals: ["new_beneficiary", "session_anomaly"], accountHandoverSignals: ["new_device_after_kyc"], aiImpersonationSignals: [], settlementWindowSeconds: 120, interventionAction: "pause_payment", recommendedAction: "Pause the payment, resolve the close payee match through the receiving institution, verify the signed agent mandate, enforce the approved spend cap, and require human confirmation for this out-of-scope beneficiary." },
];
...
export const financialReports: FinancialReport[] = [
  {
    ...
    type: "quarterly",
    summary: "Aggregate AUM up 14.2% QoQ. Fraud detection rate improved to 99.7% with new ML models. An out-of-scope agent payment is held at the authorization boundary for mandate review.",
    sections: [
      ...
      { heading: "Fraud Detection", content: "13 active alerts this quarter. 9 high/critical severity. Agentic payment controls now hold out-of-scope instructions before settlement.", highlight: 13 },
    ],
  },
];
